// ----------------------------------------------------------------------------
//  main.rs — OXIDE v8.5.0community-edition エントリポイント
...
fn print_banner() {
    ...
    let line1 = format!("=> HyperSecurity Offensive Labs  |  OXIDE v8.5.0community-edition");
    let line2 = format!("=> Open eXtensible Intelligence & Detection Engine — Community Edition * COMMUNITYv8");
