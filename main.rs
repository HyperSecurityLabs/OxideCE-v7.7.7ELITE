...
fn print_banner() {
    ...
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce --help", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u https://example.com --all", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u https://example.com --modules xss,sqli,lfi", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce  -u https://example.com --fuzz --threads 100", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u targets.txt --multiattack --output json", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u https://example.com --duration 300 --verbose", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce --list-modules", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u https://example.com --modules agent --zeroday", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u https://example.com --insta --session", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide-ce -u https://example.com --modules all --output html", ELITE_LAVENDER));
    println!("{}", tc("──────────────────────────────────────────────", ELITE_KALI));
    println!();
}
